...
try 
{
const resp=await Users.Save_Employee_Details(req.body);
return res.send(resp);
}
catch(e){
return res.send(e);
...
try 
{
Users.Search_Designation( function (err, rows) 
{
if (err) 
{
res.json(err);
...
router.get('/Search_Gender/',function(req,res,next)
{ 
try 
{
Users.Search_Gender( function (err, rows) 
{
if (err) 
{
res.json(err);
...
router.get('/Search_Account_Type/',function(req,res,next)
{ 
try 
{
Users.Search_Account_Type( function (err, rows) 
{
if (err) 
{
res.json(err);

...
router.get('/Search_Receipt_Voucher/:From_Date_?/:To_Date_?/:From_Account_Id_?/:To_Account_Id_?/:Voucher_No_?/:Is_Date_Check_?/:Payment_Status_?',function(req,res,next)
  { 
  try 
  {
    //console.log(req.params)
  Receipt_Voucher.Search_Receipt_Voucher(req.params.From_Date_,req.params.To_Date_,  req.params.From_Account_Id_,
  req.params.To_Account_Id_, req.params.Voucher_No_,req.params.Is_Date_Check_,req.params.Payment_Status_, function (err, rows) 
  {
  if (err) 
  {
    console.log(err)

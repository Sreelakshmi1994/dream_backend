...
// },
    ...
    Save_Course: async function (Course_) {
        ...
        {
            console.log(Course_)
            const result1 = await (new storedProcedure('Save_Course', 
               [Course_.Course_Id, Course_.Course_Name,
                Course_.Course_Type_Id, Course_.Course_Type_Name, Course_.Duration, 
...
Load_Mastercourse:function(callback)
	{ 
	  return db.query("CALL Load_Mastercourse()", [],callback);
	},
};
